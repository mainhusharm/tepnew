#!/usr/bin/env python3
"""
Simple Backend Server with Coupon Validation
This is a minimal backend server that provides the coupon validation endpoint
"""
...
def health_check():
    ...
    return jsonify({
        "status": "healthy",
        "message": "Simple coupon backend is running",
...
if __name__ == '__main__':
    ...
    print("🚀 Starting Simple Coupon Backend...")
