// Run this in the browser console on the Customer Service Dashboard page

console.log('🔧 Creating test users with questionnaire data...');

// Create test users with complete questionnaire data
const testUsers = [
  {
    id: 'test-user-1',
...
console.log('🔄 Now refresh the Customer Service Dashboard page to see the test users!');
console.log('Each user should show different questionnaire data based on their responses.');
