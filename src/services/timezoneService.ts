...
export const getMarketStatus = (selectedTimezone: string = 'UTC') => {
  ...
  const isWeekend = (dayOfWeek === 6) || // Saturday
                   (dayOfWeek === 0 && utcHour < 22) || // Sunday before 22:00 UTC
                   (dayOfWeek === 5 && utcHour >= 22); // Friday after 22:00 UTC
  
  // Real forex trading sessions in UTC time
  const sessions: MarketSession[] = [
    {
      name: 'Sydney',
      timezone: 'Australia/Sydney',
      openHour: 22, // Sunday 22:00 UTC - Monday 07:00 UTC
      closeHour: 7,
      isOpen: false
    },
    {
      name: 'Tokyo', 
      timezone: 'Asia/Tokyo',
      openHour: 0, // Monday 00:00 UTC - 09:00 UTC
      closeHour: 9,
      isOpen: false
    },
    {
    ...
    },
    {
      ...
      openHour: 13, // 13:00 UTC - 22:00 UTC (overlaps with London)
      closeHour: 22,
      isOpen: false
    }
  ];
  ...
  // Format current time in selected timezone with real-time updates
