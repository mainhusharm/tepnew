#!/usr/bin/env python3
"""
SIMPLE SIGNUP FIX - WORKS IMMEDIATELY
This creates a simple signup endpoint that will work from your website
"""
...
def register_user():
    ...
    try:
        ...
        print(f"📝 SIMPLE SIGNUP - Data received: {data}")
        ...
        print(f"✅ SIMPLE SIGNUP - User registered successfully: {email} (ID: {user_id})")
        return jsonify(response_data), 200
        
    except Exception as e:
        print(f"❌ SIMPLE SIGNUP - Registration error: {e}")
...
if __name__ == '__main__':
    print("🚀 SIMPLE SIGNUP FIX - WORKS IMMEDIATELY")
    print("📍 Endpoint: http://localhost:5007/api/simple/signup")
